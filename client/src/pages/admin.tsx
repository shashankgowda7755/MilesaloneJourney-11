      ...
      <div className="min-h-screen bg-brand-cream flex items-center justify-center p-4" data-testid="admin-login">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <Settings className="mx-auto text-brand-orange text-4xl mb-4" />
          ...
          <CardContent className="space-y-4">
            <Button 
              onClick={handleLogin}
              className="w-full bg-white border-2 border-gray-300 text-gray-700 hover:bg-gray-50 flex items-center justify-center space-x-3"
